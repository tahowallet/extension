...
const steps = isEnabled(FeatureFlags.HIDE_TOKEN_FEATURES)
  ? [
      ...
      },
      {
        ...
        title: "Taho is a DAO",
        body: `That means Taho is owned by our users. And all profits go straight to the community.`,
        buttonCopy: "Continue",
      },
    ]
  : [
      {
        ...
        title: "Taho is different",
        body: "Taho is the first community-owned wallet for Web3 and DeFi. If you own $DOGGO tokens, you are an owner. ",
        buttonCopy: "Continue",
      },
      {
        image: {
