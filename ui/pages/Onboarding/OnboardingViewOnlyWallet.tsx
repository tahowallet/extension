...
import { addAddressToActiveNetworks } from "@tallyho/tally-background/redux-slices/accounts"
...
export default function OnboardingViewOnlyWallet(): ReactElement {
  ...
  const handleSubmitViewOnlyAddress = useCallback(async () => {
    ...
    await dispatch(addAddressToActiveNetworks(addressOnNetwork.address))
