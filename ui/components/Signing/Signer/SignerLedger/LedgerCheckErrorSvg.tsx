  ...
  return (
    ...
    >
      ...
      <g opacity={0.7}>
        ...
        />
        <circle cx={125.503} cy={21.278} r={12.61} stroke="#F55252" />
        <path
          fill="#183736"
          fillRule="evenodd"
      ...
      <path
        fill="#F2B824"
        fillRule="evenodd"
        d="M131.765 25.268l-5.408-10.878a.4.4 0 00-.714 0l-5.408 10.878a.39.39 0 00.358.561h10.814a.39.39 0 00.358-.561zm-4.335-11.391c-.581-1.17-2.279-1.17-2.86 0l-5.407 10.878c-.515 1.037.254 2.245 1.43 2.245h10.814c1.176 0 1.945-1.208 1.43-2.245l-5.407-10.878zm-2.225 10.001c0-.43.356-.78.795-.78.439 0 .795.35.795.78 0 .431-.356.78-.795.78a.788.788 0 01-.795-.78zm.198-5.463v3.902h1.193v-3.902h-1.193z"
        clipRule="evenodd"
      />
      <text
        className="content"
