...
export default function LedgerCheckErrorSvg({
  alt,
  text,
}: {
  alt: string
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#SVGID_2_)">
        ...
        />
        <path
          d="M154.4 22.2v9.3h3.1v-9.3h-3.1zm1.6 10.7c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"
          className="st8"
        />
        <path
          d="M159.4 11.9c-1.4-2.8-5.5-2.8-6.9 0l-12.4 24.9c-1.2 2.5.6 5.4 3.4 5.4h24.7c2.8 0 4.7-2.9 3.4-5.4l-12.2-24.9zm-2.8 1.4L169 38.1c.2.5-.1 1-.6 1h-24.7c-.5 0-.9-.5-.6-1l12.4-24.9c.1-.5.9-.5 1.1.1z"
          className="st8"
        />
      </g>
      <text
