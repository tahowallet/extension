...
export const NO_VAULT_ERROR: string = "Must first create a vault or import keys to do any key operations"
export const ADDRESS_NOT_FOUND_ERROR: string = "Can not find keyring for address:"