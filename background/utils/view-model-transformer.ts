...
export const transactionPropertiesForUI = [
  ...
  "annotation.contractInfo",
  "annotation.contractInfo.nameOnNetwork",
  "annotation.contractInfo.nameOnNetwork.name",
  "annotation.contractInfo.nonce",
  "annotation.contractInfo.balance",
  "annotation.functionSignature",
  "annotation.functionSignature.abi",
  "annotation.functionSignature.selector",
