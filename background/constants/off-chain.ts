...
export const Wealthsimple: OffChainProvider = {
    ...
    logoUrl: 'https://images.ctfassets.net/v44fuld738we/3p54yem0uWnzJSPyCLdQgN/10e0569c130b369cf6b33e2f1a88acc7/_2019_Wealthsimple_Favicon_Black.png',
    name: 'Wealthsimple',
}
...
export const offChainProviders = [
    Wealthsimple,
    Binance,
    FTX,
    Coinbase
