...
function validate59(data, valCxt) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
              ...
              if (data2.tokenBalance !== undefined) {
                ...
                if (!(data4 === null || typeof data4 == "string")) {
                  var err4 = {
                    ...
                    schemaPath:
                      "/properties/tokenBalances/elements/properties/tokenBalance/type",
                    keyword: "type",
                    params: { type: "string", nullable: true },
                    message: "must be string or null",
                  }
                ...
                var err5 = {
                  instancePath: instancePath + "/tokenBalances/" + i0,
                  schemaPath:
                    "/properties/tokenBalances/elements/properties/tokenBalance",
                  keyword: "properties",
                  params: { error: "missing", missingProperty: "tokenBalance" },
                  message: "must have property 'tokenBalance'",
                }
                if (vErrors === null) {
                  vErrors = [err5]
                } else {
    ...
    for (var key1 in data) {
      if (key1 !== "address" && key1 !== "tokenBalances") {
        var err10 = {
          instancePath:
