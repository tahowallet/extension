...
describe("Utilities", () => {
  describe("determineAssetDisplayAndVerify", () => {
    ...
    describe("Remove assets", () => {
      it("should display asset amount if NOT removed (removed value set to false)", () => {
        const { displayAsset } = determineAssetDisplayAndVerify(
          createCompleteAssetAmount(
            createSmartContractAsset({ metadata: { removed: false } }),
            200,
            {
              decimalAmount: 200,
              mainCurrencyAmount: 200,
      ...
      it("should display asset amount if NOT removed (empty metadata)", () => {
        const { displayAsset } = determineAssetDisplayAndVerify(
          createCompleteAssetAmount(createSmartContractAsset(), 200, {
            decimalAmount: 200,
            mainCurrencyAmount: 200,
      ...
      it("should NOT display asset amount if removed", () => {
        const { displayAsset } = determineAssetDisplayAndVerify(
          createCompleteAssetAmount(
            createSmartContractAsset({ metadata: { removed: true } }),
            200,
            {
              decimalAmount: 200,
              mainCurrencyAmount: 200,
