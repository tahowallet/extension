...
export const TESTNET_TAHO: SmartContractFungibleAsset = {
  name: "Taho",
  symbol: "TAHO",
  decimals: 18,
  contractAddress:
...
export const TESTNET_TAHO_DEPLOYER_ADDRESS =
  process.env.TESTNET_TAHO_DEPLOYER_ADDRESS ?? ethers.constants.AddressZero

const TESTNET_XP_ABI = [
    {
      "inputs": [],
...
const TESTNET_TAHO_DEPLOYER_ABI = [
  {
    inputs: [],
    stateMutability: "nonpayable",
    type: "constructor",
  ...
  {
    inputs: [],
    name: "BALANCER_POOL_AGENT_DEPLOYER_DEPLOY_HASH",
    outputs: [
      {
        internalType: "bytes32",
        name: "",
...
export function buildRealmContract(address: NormalizedEVMAddress): ethers.Contract {
...
export const TestnetTahoDeployer = new ethers.Contract(
  TESTNET_TAHO_DEPLOYER_ADDRESS,
  TESTNET_TAHO_DEPLOYER_ABI,
)
